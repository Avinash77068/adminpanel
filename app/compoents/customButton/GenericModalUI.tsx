      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6">
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
          <p className="text-gray-800">
            ...
            <span className="font-bold text-red-700">John Doe</span>?
          </p>
        ...
        <div className="flex space-x-4">
          ...
          <button className="flex-1 border border-gray-300 text-gray-700 font-semibold py-2 rounded-lg hover:bg-gray-100 transition">
            Cancel
          </button>
        </div>
      </div>
